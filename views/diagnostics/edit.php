...
<div class="bg-white shadow">
    <div class="px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <h1 class="text-2xl font-semibold text-gray-900">
            Editar Diagnóstico: <?php echo htmlspecialchars($diagnostico['paciente_nombre'] . ' ' . $diagnostico['paciente_apellidos']); ?>
        </h1>
        <div class="flex space-x-2">
            <a href="?page=diagnostics&action=view&id=<?php echo $diagnostico['id']; ?>" class="btn-secondary">
...
<div class="mt-6">
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            ...
            <form action="?page=diagnostics&action=edit&id=<?php echo $diagnostico['id']; ?>" method="POST" enctype="multipart/form-data" class="space-y-6" id="editDiagnosticForm">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" id="descripcion" rows="4" required
                                  ...
                                  placeholder="Describa el diagnóstico detalladamente..."><?php echo htmlspecialchars($diagnostico['descripcion']); ?></textarea>
                    </div>
                </div>
                        ...
                        <div class="mt-2 flex items-center">
                            <div class="preview-container h-40 w-40 bg-gray-100 flex items-center justify-center">
                                <?php if ($diagnostico['imagen_diagnostico']): ?>
                                    <img id="preview" src="<?php echo UPLOADS_PATH . '/' . $diagnostico['imagen_diagnostico']; ?>" 
                                         alt="Imagen del diagnóstico" class="max-h-full max-w-full">
                                    <i class="fas fa-image text-4xl text-gray-400 hidden" id="defaultIcon"></i>
                                <?php else: ?>
                            ...
                            <div class="ml-5">
                                ...
                                <button type="button" onclick="document.getElementById('imagen_diagnostico').click()"
                                        class="btn-secondary">
                                    <i class="fas fa-upload mr-2"></i>Cambiar imagen
                                </button>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Estado del Diagnóstico</h3>
                    ...
                    <div>
                        ...
                        <select name="estado" id="estado" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <option value="activo" <?php echo $diagnostico['estado'] === 'activo' ? 'selected' : ''; ?>>
                                Activo
                            </option>
                            <option value="completado" <?php echo $diagnostico['estado'] === 'completado' ? 'selected' : ''; ?>>
                                Completado
                            </option>
                            <option value="cancelado" <?php echo $diagnostico['estado'] === 'cancelado' ? 'selected' : ''; ?>>
                                Cancelado
                            </option>
                        </select>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let odontogramaData = <?php echo $diagnostico['odontograma']; ?>;
