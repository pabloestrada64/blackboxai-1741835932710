...
<div class="mt-6">
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            ...
            <form action="?page=users&action=edit&id=<?php echo $usuario['id']; ?>" method="POST" enctype="multipart/form-data" class="space-y-6" id="editUserForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="rol" id="rol" required
                                ...
                                <option value="odontologo" <?php echo $usuario['rol'] === 'odontologo' ? 'selected' : ''; ?>>
                                    Odontólogo
                                </option>
                                <option value="enfermera" <?php echo $usuario['rol'] === 'enfermera' ? 'selected' : ''; ?>>
                                    Enfermera
                                </option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="estado" value="1" class="form-radio" 
