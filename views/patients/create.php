...
<div class="bg-white shadow">
    <div class="px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <h1 class="text-2xl font-semibold text-gray-900">Registrar Nuevo Paciente</h1>
...
<div class="mt-6">
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            ...
            <form action="?page=patients&action=create" method="POST" enctype="multipart/form-data" class="space-y-6" id="createPatientForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" required
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   value="<?php echo isset($oldInput['fecha_nacimiento']) ? htmlspecialchars($oldInput['fecha_nacimiento']) : ''; ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="genero" id="genero" required
                                ...
                                <option value="M" <?php echo (isset($oldInput['genero']) && $oldInput['genero'] === 'M') ? 'selected' : ''; ?>>
                                    Masculino
                                </option>
                                <option value="F" <?php echo (isset($oldInput['genero']) && $oldInput['genero'] === 'F') ? 'selected' : ''; ?>>
                                    Femenino
                                </option>
                                <option value="O" <?php echo (isset($oldInput['genero']) && $oldInput['genero'] === 'O') ? 'selected' : ''; ?>>
                                    Otro
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="tel" name="telefono" id="telefono" required
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   value="<?php echo isset($oldInput['telefono']) ? htmlspecialchars($oldInput['telefono']) : ''; ?>">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="direccion" id="direccion" rows="3" required
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo isset($oldInput['direccion']) ? htmlspecialchars($oldInput['direccion']) : ''; ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="tipo_sangre" id="tipo_sangre"
                                ...
                                foreach ($tipos_sangre as $tipo) {
                                    $selected = (isset($oldInput['tipo_sangre']) && $oldInput['tipo_sangre'] === $tipo) ? 'selected' : '';
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alergias" id="alergias" rows="2"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Describa las alergias conocidas"><?php echo isset($oldInput['alergias']) ? htmlspecialchars($oldInput['alergias']) : ''; ?></textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="enfermedades_cronicas" id="enfermedades_cronicas" rows="2"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Describa las enfermedades crónicas"><?php echo isset($oldInput['enfermedades_cronicas']) ? htmlspecialchars($oldInput['enfermedades_cronicas']) : ''; ?></textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="medicamentos_actuales" id="medicamentos_actuales" rows="2"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Liste los medicamentos que toma actualmente"><?php echo isset($oldInput['medicamentos_actuales']) ? htmlspecialchars($oldInput['medicamentos_actuales']) : ''; ?></textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="antecedentes_familiares" id="antecedentes_familiares" rows="2"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Describa los antecedentes familiares relevantes"><?php echo isset($oldInput['antecedentes_familiares']) ? htmlspecialchars($oldInput['antecedentes_familiares']) : ''; ?></textarea>
                        </div>
                    </div>
                </div>
